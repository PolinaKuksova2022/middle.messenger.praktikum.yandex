...
export const Main = () => Handlebars.compile(template)({
    buttons: [
        ...
        RedirectBtn ({text: 'Регистрация', className: 'button', ref: '/registration'}),
        RedirectBtn ({text: 'Профиль', className: 'button', ref: '/profile'}),
        RedirectBtn ({text: 'Лента переписки', className: 'button', ref: '/chat'}),
        RedirectBtn ({text: 'Error404', className: 'button', ref: '*'}),
        RedirectBtn ({text: 'Error500', className: 'button', ref: '/internal-server-error'}),
    ],
});